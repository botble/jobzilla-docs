...
> {warning} On this project, we're using the latest Laravel version (currently 9.x). Please go to [Laravel documentation page](https://laravel.com/docs) for more information.
...
- Don't use sample data:
    ...
    - Run `php artisan cms:theme:activate jobzilla`
